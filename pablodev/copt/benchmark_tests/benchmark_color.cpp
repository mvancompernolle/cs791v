...
void BkColor::Dimacs(){
///////////////////
// Used for Malagut comparison tests
...
//	add_test("homer.col");  		//Problemas
	...
	add_test("r125.5.col");			//Me da problemas siempre
	add_test("r250.1.col");
...
//	add_test("4-FullIns_5.col");		//Memoria
...
//	add_test("DSJC500.9.col");		//Me da problemas al leer. Entender
	...
	add_test("wap01a.col");
	add_test("wap02a.col");
//	add_test("wap03a.col");   //Memoria
//	add_test("wap04a.col");   //Memoria
	add_test("wap05a.col");
	add_test("wap06a.col");
	add_test("wap07a.col");
	add_test("wap08a.col");
...
void BkColor::EasyDimacs(){
	...
	add_test("anna.col");
//	add_test("homer.col");			//El problema es el el LB es malo, comparado con Trick y compaia
	add_test("huck.col");
	add_test("jean.col");
	add_test("david.col");
